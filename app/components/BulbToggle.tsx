  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={
          isLight
            ? { filter: "drop-shadow(0 0 10px rgba(255,220,50,0.8))" }
            : {}
        }
      >
        <svg width="40" height="52" viewBox="0 0 40 52" fill="none">
          ...
          <motion.path
            ...
            animate={{ fill: isLight ? "#ffe97a" : "#2a2a3a" }}
      ...
      <AnimatePresence>
        {isLight && (
          <motion.div
            className="absolute top-8 w-20 h-20 rounded-full pointer-events-none"
            style={{ background: "rgba(255,220,50,0.15)" }}
